...
use oxxlobs_abstractions::{BridgeKind, InterpretationLimit, ScenarioId};
...
mod tests {
    ...
    const BRIDGE_FIXTURE: &str = include_str!(
        "../../../docs/test-corpus/excel/xlobs_provenance_excel_build_001/bridge.json"
    );
    ...
    fn rejects_non_pure_rust_bridge_without_executable_identity() {
        let envelope = BridgeEnvelope {
            scenario_id: ScenarioId("xlobs_provenance_excel_build_001".to_owned()),
