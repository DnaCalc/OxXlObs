...
use oxxlobs_abstractions::{CaptureLoss, ObservationUncertainty, ScenarioId};
use oxxlobs_bridge::{BridgeEnvelope, BridgeEnvelopeValidationError, validate_bridge_envelope};
...
mod tests {
    ...
    const PROVENANCE_FIXTURE: &str = include_str!(
        "../../../docs/test-corpus/excel/xlobs_provenance_excel_build_001/provenance.json"
    );
