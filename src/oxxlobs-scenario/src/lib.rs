...
use oxxlobs_abstractions::{ObservableSurface, ReplayClass, ScenarioId};
...
mod tests {
    ...
    use oxxlobs_abstractions::{ObservableSurface, ObservableSurfaceKind, ReplayClass, ScenarioId};

    const VALID_SCENARIO_FIXTURE: &str = include_str!(
        "../../../docs/test-corpus/excel/xlobs_manifest_minimal_valid_001/scenario.json"
    );
    const INVALID_SCENARIO_FIXTURE: &str = include_str!(
        "../../../docs/test-corpus/excel/xlobs_manifest_invalid_missing_surface_001/scenario.json"
    );
    ...
    fn rejects_duplicate_surface_ids() {
        let scenario = ObservationScenario {
            scenario_id: ScenarioId("xlobs_manifest_minimal_valid_001".to_owned()),
            replay_class: ReplayClass::ScenarioManifestValid,
            retained_root: "docs/test-corpus/excel/xlobs_manifest_minimal_valid_001".to_owned(),
