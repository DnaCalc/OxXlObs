...
1. `docs/test-corpus/excel/xlplay_capture_values_formulae_001/`
2. `states/excel/xlplay_capture_values_formulae_001/`

## Driver evidence summary
1. The stable path runs through `dna-xl-play capture-run`, which invokes `scripts/invoke-excel-observation.ps1` as a narrow external bridge seam.
...
4. The retained live bundle preserves repo-relative sidecars for the environment and bridge witnesses under `states/excel/xlplay_capture_values_formulae_001/`.

## Current limits
1. The stable driver path is currently exercised only for `xlplay_capture_values_formulae_001`.
